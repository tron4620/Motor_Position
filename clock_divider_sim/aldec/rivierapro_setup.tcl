...
# ACDS 17.1 590 linux 2019.04.12.14:59:47
# ----------------------------------------
...
# ----------------------------------------
# If clock_divider is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "clock_divider"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clock_divider.vo"
}
